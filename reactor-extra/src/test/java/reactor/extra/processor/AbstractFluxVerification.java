 ...
 */
public abstract class AbstractFluxVerification extends org.reactivestreams.tck.PublisherVerification<Integer> {
	...
	public Publisher<Integer> createFailedPublisher() {
		return Flux.<Integer>error(new Exception("oops")).transform(this::transformFlux);
	}
