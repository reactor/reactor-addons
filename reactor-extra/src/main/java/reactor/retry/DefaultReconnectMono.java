...
final class DefaultReconnectMono<T> extends ReconnectMono<T>
	...
	static final AtomicReferenceFieldUpdater<DefaultReconnectMono, ReconnectInner[]>SUBSCRIBERS =
			AtomicReferenceFieldUpdater.newUpdater(
					DefaultReconnectMono.class, ReconnectInner[].class, "subscribers");
	...
	final static class ReconnectInner<T> extends MonoSubscriber<T, T> {
		final DefaultReconnectMono<T> parent;

		ReconnectInner(CoreSubscriber<? super T> actual, DefaultReconnectMono<T> parent) {
			super(actual);
			this.parent = parent;
		}
