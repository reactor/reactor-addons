...
/**
 * Exception indicating that retries or repeats have been exhausted after
 * reaching {@link RetryBuilder#timeout(java.time.Duration)} or
 * {@link RetryBuilder#maxAttempts(int)}. For retries, {@link #getCause()}
 * returns the original exception from the last retry attempt that
